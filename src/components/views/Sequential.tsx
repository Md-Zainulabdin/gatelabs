...
export const SequentialView = () => {
  ...
  const { inputs, outputs, toggleInput, reset } = useSequential(circuit);
        ...
        <div className="card p-6 space-y-12">
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="ml-4">
              <button
                onClick={reset}
                aria-label="Reset circuit inputs and outputs"
                className="cursor-pointer inline-flex items-center px-3 py-1.5 bg-zinc-100 border border-zinc-200 text-sm rounded-md hover:bg-zinc-200"
              >
                Reset
              </button>
            </div>
